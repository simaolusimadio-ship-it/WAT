...
export const WATCheckoutModal: React.FC<Props> = ({
  ...
  const shipping = subtotal > 500 || isDigital ? 0 : 45.0;
            ...
            <div className="lg:col-span-7 p-5 sm:p-7 space-y-6 border-b lg:border-b-0 lg:border-r border-black/[0.08] bg-white">
              ...
              <section className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  >
                    {isEditingAddress ? 'Done Editing' : 'Edit Details'}
                  </button>
                </div>

                {!isEditingAddress ? (
                  <div className="bg-neutral-50/80 border border-black/[0.06] rounded-2xl p-4 text-xs space-y-1 text-neutral-700">
                    <div className="font-bold text-neutral-900 text-sm">{customer.name}</div>
                  ...
                  <div className="bg-neutral-50 border border-black/[0.08] rounded-2xl p-4 space-y-3 text-xs">
                    <div className="grid grid-cols-2 gap-2">
                      <div>
                        <label className="block text-[11px] font-bold text-neutral-600 mb-1">Full Name</label>
                        <input
                          type="text"
                          value={customer.name}
                ...
                >
                  {isProcessing ? (
                    ...
                    <>
                      ...
                      <span>
                        Pay {currency} {finalTotal.toLocaleString(undefined, { minimumFractionDigits: 2 })} Now
                      </span>
